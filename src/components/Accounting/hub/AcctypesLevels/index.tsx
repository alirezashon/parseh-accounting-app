        ...
        {nodes.map((node) => {
          ...
          return (
            <li
              ...
              } rounded-2xl my-3 border-l-5 shadow-2xs shadow-blue-100 `}
              style={{
                borderLeft: node.chlevel === 1 ? '22px ridge #2F27CE' : '',
              }}
            >
              <div
  ...
  return (
    <MainLayout>
      ...
      <div className='p-6 bg-gray-50 min-h-screen'>
        <div className='text-xl font-bold mb-6'>درخت بازاریابی</div>
