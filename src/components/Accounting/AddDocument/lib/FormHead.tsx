...
//         Number: parseInt(String(values.Number)) || 0,
//         Sequence: parseInt(String(values.Sequence)) || 0,
//         DailyNumber: parseInt(String(values.DailyNumber)) || 0,
//         VoucherTypeRef: 0,
//         IsCurrencyBased: 0,
...
// lib/FormHead.tsximport Divider from '@/components/hub/Forms/Divider'
import { FieldConfig } from './data'
import { buildForm } from './ElementCreator'
