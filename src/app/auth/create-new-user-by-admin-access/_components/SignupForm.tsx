  ...
  const onSubmit: SubmitHandler<ISignupForm> = async (data: ISignupForm) => {
    try {
      ...
      const regirsterScheme: ISignupForm = {
        ...
        mobile: `${data.mobile}`,
        presenter_mobile: `${data.presenter_mobile}`,
        password: `${firstInputRef?.current?.value}`,
        user_type: 2,
      }
        ...
        <form onSubmit={handleSubmit(onSubmit)} className='flex flex-col'>
          <div className='grow mb-8'>
            ...
            <div className='mb-6 sm:mb-8'>
              ...
              />
              {errors?.mobile && (
                <p className='mt-2 text-red-400'>{errors?.mobile?.message}</p>
              )}
            </div>
            <div className='mt-5'>
              <b>رمز عبور </b>
            ...
            <div className='mb-6 sm:mb-8'>
              <Controller
                ...
                render={({ field: { onChange, value, ref } }) => (
                  <>
                    ...
                    <input
                      ...
                      className={`w-full !rounded-lg ${
                        referrerCode && referrerCode?.length < 0
                          ? 'reopacity-50'
                          : ''
                      }`}
                      onChange={onChange}
                ...
                name='presenter_mobile'
              />
              {errors?.presenter_mobile && (
                <p className='mt-2 text-red-400'>
                  {errors?.presenter_mobile?.message}
                </p>
              )}
            </div>
          </div>
